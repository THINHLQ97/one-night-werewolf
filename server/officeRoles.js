...
const OFFICE_ROLES = {
  ...
  toxic_manager: {
    ...
    nightOrder: 1.1, hasNightAction: true, maxCount: 1, emoji: '😤', expansion: 'office',
  ...
  stalker: {
    ...
    nightOrder: 1.2, hasNightAction: true, maxCount: 1, emoji: '👀', expansion: 'office',
    wakesWithSnakes: true,
  ...
  snoop: {
    ...
    nightOrder: 1.3, hasNightAction: true, maxCount: 1, emoji: '🔍', expansion: 'office',
    wakesWithSnakes: true,
  ...
  dumper: {
    ...
    nightOrder: 7.5, hasNightAction: true, maxCount: 1, emoji: '📦', expansion: 'office',
    multiStep: true,
  ...
  paranoid: {
    ...
    description: 'Thức dậy cuối cùng nhóm Staff. Xem bài hiện tại của chính mình.',
  ...
  legal: {
    ...
    nightOrder: 9, hasNightAction: true, maxCount: 1, emoji: '⚖️', expansion: 'office',
...
const ACTIVE_NIGHT_ROLES = [
  'outsourcing',
  'snake', 'toxic_manager', 'stalker', 'snoop',
  'netizen',
  'tracker',
  'spammer',
  'ceo',
