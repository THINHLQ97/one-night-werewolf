...
const ROLES = [
  ...
  },
  {
    ...
    team: 'village', teamLabel: 'Phe Dân (có thể đổi)', nightOrder: null, expansion: 'daybreak',
    lore: 'Người Bị Nguyền mang trên mình dấu ấn cổ xưa — một biểu tượng huyết hồng ai chưa từng thấy. Truyền thuyết kể rằng tổ tiên của họ đã phạm tội phản bội một Sói Đầu Đàn vào đêm trăng tròn, và lời nguyền truyền qua bao thế hệ. Họ sống như Dân làng bình thường, nhưng dòng máu của họ PHẢN ỨNG với ý đồ ác độc của Ma Sói. Khi Sói chỉ tay vào họ trong cơn cuồng nộ phán xét, lời nguyền sống dậy.\n\nNhưng số phận có hai mặt: Nếu họ chết dưới ánh nhìn của Sói, máu họ trở thành tế lễ cứu rỗi cả làng — họ trở thành ANH HÙNG hy sinh. Nhưng nếu họ sống sót qua cơn phán xét của Sói, lời nguyền không kịp chết theo họ — nó bám vào linh hồn họ, biến họ thành chính kẻ thù mà họ đáng lẽ phải tiêu diệt. Đó là sự lựa chọn không công bằng: chết như anh hùng, hoặc sống như kẻ phản bội.',
    nightAction: 'Không thức dậy ban đêm.',
    winCondition: 'KHỞI ĐẦU phe Dân. Nếu có Sói vote + bị loại → ANH HÙNG (thắng cùng Dân). Nếu có Sói vote + KHÔNG bị loại → biến thành Sói.',
    tips: 'Khiêu khích thông minh để Sói vote bạn — nếu thành công bị giết, bạn thắng. Nếu Sói vote nhưng bạn sống → bạn thành Sói.',
    nightScript: 'Bị Nguyền không thức dậy ban đêm.',
    howToPlay: 'Ban đêm: Không có hành động.\n\nBan ngày: Bạn KHỞI ĐẦU thuộc phe Dân, nhưng vai của bạn có thể đổi tùy kịch bản:\n\n📋 4 KỊCH BẢN:\n\n✅ KỊCH BẢN 1: Không Sói vote bạn\n• Bạn vẫn là Dân (mặc định)\n• Dân thắng → bạn thắng (+điểm)\n• Sói thắng → bạn thua (-5 điểm)\n\n🦸 KỊCH BẢN 2: Có Sói vote + BẠN BỊ LOẠI (Anh hùng)\n• Bạn HY SINH như anh hùng\n• Tính như "Sói bị loại" → DÂN THẮNG\n• Bạn vẫn là Dân về win condition → BẠN THẮNG (+điểm)\n• Đây là kịch bản tốt nhất cho bạn!\n\n💀 KỊCH BẢN 3: Có Sói vote + BẠN KHÔNG BỊ LOẠI (Bị nguyền)\n• Lời nguyền trigger → bạn CHUYỂN HẲN sang phe Sói\n• Phe Sói thắng → bạn thắng (+điểm)\n• Phe Dân thắng → bạn thua (-5 điểm)\n• Bạn mất kiểm soát đội mình thuộc về!\n\n🪦 KỊCH BẢN 4: Bạn bị loại nhưng KHÔNG có Sói vote\n• Chỉ Dân vote bạn → bạn chết như Dân thường\n• Sói vẫn sống → Sói thắng → bạn THUA (-5 điểm)\n• Kịch bản tệ nhất!\n\n📋 CHIẾN THUẬT (vai khó & độc đáo):\n1️⃣ KHIÊU KHÍCH SÓI: Nói dối có chiến lược để Sói vote bạn (không phải Dân)\n2️⃣ MỤC TIÊU: ĐƯỢC SÓI VOTE + BỊ DÂN VOTE THEO\n   • Sói vote bạn → kích hoạt cơ chế\n   • Dân vote theo → đủ phiếu loại bạn\n   • Kết quả: Anh hùng, Dân thắng, bạn thắng\n3️⃣ TRÁNH: Sói vote nhưng Dân không tin → bạn sống → đổi phe → thường thua\n4️⃣ MẸO: Giả Tiên Tri/Mason giả → Sói sẽ nghĩ bạn nguy hiểm và vote bạn\n\n💡 PARADOX:\n• Quá khéo → Sói không vote bạn → bạn vẫn Dân, nhưng không đặc biệt\n• Khiêu khích thành công → Sói vote + Dân tin theo → Anh hùng → thắng!\n• Khiêu khích nửa vời → Sói vote nhưng Dân không vote → sống → bị nguyền → thường thua\n\n⚠️ ĐÒI HỎI: Hiểu tâm lý cả 2 phe. Vai phù hợp với người chơi giàu kinh nghiệm.\n\nMục tiêu: Trở thành anh hùng hy sinh cho phe Dân.',
  },
  {
