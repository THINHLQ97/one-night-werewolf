...
const ROLES = [
  ...
  },
  {
    ...
    team: 'village', teamLabel: 'Phe Dân (có thể chuyển)', nightOrder: null, expansion: 'daybreak',
    lore: 'Người Bị Nguyền mang trên mình dấu ấn cổ xưa — một biểu tượng huyết hồng ai chưa từng thấy. Truyền thuyết kể rằng tổ tiên của họ đã phạm tội phản bội một Sói Đầu Đàn vào đêm trăng tròn, và lời nguyền truyền qua bao thế hệ. Họ sống như Dân làng bình thường, ăn bữa cùng dân, làm việc cùng dân, mơ cùng dân. Nhưng dòng máu của họ PHẢN ỨNG với ý đồ ác độc của Ma Sói. Khi một con Sói chỉ tay vào họ trong cơn cuồng nộ phán xét, lời nguyền sống lại — máu họ sôi lên, bóng đen tràn ngập linh hồn, và họ HÓA THÀNH chính kẻ thù mà họ đáng lẽ phải tiêu diệt.\n\nĐó là bản án nghiệt ngã: trở thành phản kẻ phản bội ngay khoảnh khắc bị nghi ngờ phản bội. Nếu họ chết với bộ lông sói lên cơ thể, dân làng đã làm đúng — nhưng chính họ đã mất linh hồn vĩnh viễn.',
    nightAction: 'Không thức dậy ban đêm.',
    winCondition: 'Mặc định thắng cùng phe Dân. NHƯNG nếu có ≥1 Sói vote → chuyển hẳn sang phe Sói (thắng/thua theo phe Sói).',
    tips: 'Né vote của Sói bằng mọi giá. Nếu Sói vote bạn → bạn đã đổi phe và mất kiểm soát. Đe dọa Sói để họ vote người khác.',
    nightScript: 'Bị Nguyền không thức dậy ban đêm.',
    howToPlay: 'Ban đêm: Không có hành động.\n\nBan ngày: Bạn KHỞI ĐẦU thuộc phe Dân, nhưng lời nguyền có thể trigger:\n🩸 Nếu có ÍT NHẤT 1 SÓI vote bạn → bạn CHUYỂN HẲN sang phe Sói (vĩnh viễn cho ván này)\n🩸 Chuyển phe áp dụng cho mọi mục đích: win condition, elimination tally, ranking points\n\n📋 CÁC TÌNH HUỐNG:\n✅ Không Sói vote bạn:\n• Bạn vẫn là phe Dân\n• Nếu Dân thắng → bạn thắng (+điểm)\n• Nếu Sói thắng → bạn thua (-5 điểm)\n\n⚠️ Có Sói vote bạn (kể cả chỉ 1 vote):\n• Bạn CHUYỂN sang phe Sói\n• Nếu bạn bị loại → Dân thắng (giết Sói) → BẠN THUA (-5 điểm)\n• Nếu bạn không bị loại + Sói thắng → bạn thắng (+điểm)\n• Nếu bạn không bị loại + Dân thắng → bạn thua\n\n📋 CHIẾN THUẬT (vai SIÊU KHÓ):\n1️⃣ NÉ VOTE SÓI: Mục tiêu CỐT LÕI là KHÔNG để Sói vote bạn\n2️⃣ ĐỪNG KHIÊU KHÍCH: Nếu Sói nghi bạn nguy hiểm, họ sẽ vote bạn → bạn mất phe Dân\n3️⃣ ĐỔ HƯỚNG: Đẩy nghi ngờ về người khác để Sói vote người đó\n4️⃣ NGẦM HỖ TRỢ: Hỗ trợ Tiên Tri/Mason bằng cách vote Sói nhưng đừng quá nổi bật\n\n💡 NGHỊCH LÝ: Càng đóng vai Dân thông minh và hiệu quả, càng có khả năng Sói nhắm tới bạn. Đôi khi cần "đần một chút" để qua mặt.\n\n⚠️ CẢNH BÁO: Nếu bị Sói vote, bạn KHÔNG biết mình đã đổi phe — game chỉ tính khi kết thúc. Hãy nhớ rằng vote của Sói có thể là cái án tử cho bạn.\n\nMục tiêu: Sống sót, né vote Sói, và thắng cùng phe Dân.',
  },
  {
