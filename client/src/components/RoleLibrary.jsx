...
const ROLES = [
  ...
  },
  {
    ...
    lore: 'Hoàng Tử sinh ra trong dòng máu vương giả. Dân làng kính trọng ông, không ai dám đặt tay lên người ông dù trong cơn cuồng nộ tập thể. Ông không có sức mạnh đặc biệt, nhưng địa vị của ông là tấm khiên vô hình — không lá phiếu nào có thể đưa ông tới giá treo cổ. Khi cả làng đồng lòng kết tội Hoàng Tử, họ phải đối mặt với sự thật phũ phàng: kẻ thật sự cần bị loại đang đứng ngay cạnh họ.',
    nightAction: 'Không thức dậy ban đêm.',
    winCondition: 'Thắng cùng phe Dân. Bạn MIỄN DỊCH với vote — không thể bị loại.',
    tips: 'Tự nhận là Hoàng Tử để tránh Sói vote bạn. Bảo vệ Tiên Tri, Mason, P.I. khỏi vote bằng cách hút phiếu về mình.',
    nightScript: 'Hoàng Tử không thức dậy ban đêm.',
    howToPlay: 'Ban đêm: Không có hành động.\nBan ngày: Bạn được vote bình thường — NHƯNG kể cả khi bạn bị vote nhiều nhất, bạn KHÔNG bị loại.\n💡 Người có phiếu cao thứ 2 (≥2 phiếu) sẽ bị loại thay.\n⚠️ Nếu bạn bị Robber/Witch/Troublemaker đổi bài → bạn KHÔNG còn miễn dịch (chỉ vai hiện tại tính)\nMục tiêu: Dùng địa vị để bảo vệ Dân, hấp dẫn vote Sói.',
  },
  {
    id: 'cursed', name: 'Cursed', nameVi: 'Bị Nguyền', emoji: '🩸',
    team: 'village', teamLabel: 'Phe Dân', nightOrder: null, expansion: 'daybreak',
    lore: 'Người Bị Nguyền mang trên mình dấu ấn của bóng tối — một lời nguyền cổ xưa khiến họ trở nên... khác biệt. Họ là Dân làng theo bản chất, nhưng khi Sói thực sự để ý đến họ và muốn loại bỏ, lời nguyền trỗi dậy biến họ thành kẻ giả vờ làm Sói. Đó là sự cay đắng của số phận: chỉ khi Sói gây hại cho họ, họ mới trở thành công cụ tiêu diệt chính Sói.',
    nightAction: 'Không thức dậy ban đêm.',
    winCondition: 'Thắng cùng phe Dân. NẾU bị Sói vote và bị loại → Dân thắng (bạn chuyển thành Sói khi chết).',
    tips: 'Cố gắng bị Sói vote — vì khi bạn bị Sói vote, bạn trở thành mục tiêu chiến lược của Dân để loại "Sói giả".',
    nightScript: 'Bị Nguyền không thức dậy ban đêm.',
    howToPlay: 'Ban đêm: Không có hành động.\nBan ngày: Bạn là Dân BÌNH THƯỜNG cho đến khi bị vote.\n🩸 KHẢ NĂNG ĐẶC BIỆT: Khi tính kết quả, nếu BẠN BỊ LOẠI VÀ có ÍT NHẤT 1 SÓI vote bạn → bạn được tính là "Sói bị loại" → Phe Dân THẮNG!\n💡 Chiến thuật: Khiêu khích Sói vote bạn (đe dọa Sói, giả Tiên Tri) — nếu họ vote bạn và bạn chết, họ đã tự thua.\nMục tiêu: Trở thành "trap" cho Sói.',
  },
  {
    ...
    lore: 'Tiên Tri Hào Quang không nhìn thấy bài, không thấy mặt — chỉ thấy được "hơi thở" của hành động trong đêm. Khi một ai đó vừa cử động bài, hào quang của họ rực sáng trong ánh nhìn của cô. Cô không biết họ đã làm gì, nhưng cô biết AI đã hoạt động và AI đã ngủ yên. Một sức mạnh tinh tế: phân biệt người tham gia khỏi người đứng ngoài cuộc.',
    nightAction: 'Thức dậy sau Kẻ Quậy (thứ 7C). Thấy ai ĐÃ xem hoặc đổi bài đêm nay.',
    winCondition: 'Thắng cùng phe Dân.',
    tips: 'Biết ai có vai active → loại trừ Villager/Hunter/Tanner/Bodyguard. Sói cũng "có hào quang" → nghi ngờ những người có vai action mà giả vờ là Villager.',
    nightScript: '"Tiên Tri Hào Quang, hãy mở mắt. Những ai đã xem hoặc đổi bài giơ ngón cái lên." — Tiên Tri Hào Quang ghi nhớ. "Tiên Tri Hào Quang, hãy nhắm mắt lại."',
    howToPlay: 'Ban đêm: Thức dậy giữa đêm (sau Kẻ Quậy, trước Ngốc Làng).\n✨ Bạn thấy danh sách những người ĐÃ xem hoặc đổi bài tính đến thời điểm này.\n📋 CÓ hào quang: Seer, Mystic Wolf, Robber, Troublemaker, Witch, P.I., Apprentice Seer, Alpha Wolf, Werewolf solo (peek), Doppelganger\n📋 KHÔNG hào quang: Villager, Hunter, Tanner, Mason, Minion, Sentinel, Dream Wolf, Bodyguard, Prince, Cursed (và các vai sau Aura Seer: Village Idiot, Drunk, Insomniac, Revealer)\nBan ngày: So sánh với khai báo của mọi người. Ai khai Villager nhưng có hào quang → đáng nghi (có thể là Sói).\nMục tiêu: Phát hiện kẻ nói dối qua hào quang.',
  },
  {
